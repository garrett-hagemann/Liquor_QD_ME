@everywhere using DataArrays, DataFrames, ForwardDiff, NLsolve, Roots, Distributions, Optim, Interpolations, LineSearches
...
test = pmap(ss_est,tups)
writedlm(csvfile,test,"|")
close(csvfile)
